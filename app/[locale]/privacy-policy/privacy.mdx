...
This privacy policy applies between you, the User of this Website, and TakeNote AI, the owner and provider of this Website. TakeNote AI takes the privacy of your information very seriously.  This privacy policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.

Please read this privacy policy carefully.

Definitions and interpretation

1\.  In this privacy policy, the following definitions are used: Data: collectively all information that you submit to TakeNote AI (TakeNote) via the Website.  This  definition incorporates, where applicable, the definitions provided in the Data Protection Laws; Data Protection Laws; any applicable law relating to the processing of personal Data including but not limited to the GDPR, and any national implementing and supplementary laws, regulations and secondary legislation; GDPR: the UK General Data Protection Regulation; TakeNote of 7 Bell Yard, London, WC2A 2JR.

User or you:  any third party that accesses the Website and is not either (i) employed by TakeNote and acting in the course of their employ mentor (ii) engaged as a consultant or otherwise providing services to TakeNote and accessing the Website in connection with the provision of such services; and Website: the website that you are currently using, www.TakeNote.ai, and any sub-domains of this site.
...
3\.  This privacy policy applies only to the actions of TakeNote and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.

4\.  For purposes of the applicable Data Protection Laws, TakeNote is the "data controller". This means that TakeNote determines the purposes for which, and the manner in which, your Data is processed.

Data collected

5\.  We may collect the following Data, which includes personal Data, from you in each case, in accordance with this privacy policy.
...
7\.  TakeNote will collect your Data in a number of ways, for example:

a. when you contact us through the Website, by telephone, post, e-mail or through any other means;

b. when you register with us and set up an account to receive our products/services; in each case, in accordance with this privacy policy. 
...
14\.  Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail address: contact@TakeNote.ai
...
d. Right to restrict our use of your Data - the right to "block" us from using your Data or limit the way in which wecan use it.

e. Right to data portability - the right to request that we move, copy or transfer your Data.

f. Right to object - the right to object to our use of your Data including where we use it for our legitimate interests.

19\.  To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail address: contact@TakeNote.ai
...
23\.  TakeNote may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of TakeNote. Data provided by Users will, where it is relevant to any partof our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this privacy policy,be permitted to use the Data for the purposes for which it was originally supplied to us.
...
30\. TakeNote AI reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations.

You may contact TakeNote AI by email at contact@TakeNote.ai
