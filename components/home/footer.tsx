...
const navigation = [
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/TakeNoteAI',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className='mx-auto max-w-7xl px-6 py-6 gap-2 text-sm flex flex-col lg:px-8'>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5 text-gray-500">
            &copy; {dayjs().year()} Takenote.ai, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
