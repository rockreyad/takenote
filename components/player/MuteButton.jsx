...
export function MuteButton({ player }) {
  return (
    <button
      type="button"
      className="group relative rounded-md hover:bg-slate-100 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 md:order-none"
    ...
    >
      ...
      <MuteIcon
        muted={player.muted}
        className="h-6 w-6 fill-primary stroke-primary group-hover:fill-primary/80 group-hover:stroke-primary/80"
      />
    </button>
  );
}
