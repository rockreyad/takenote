...
export function AudioPlayer({ title, src }) {
  ...
  return (
    <div className="flex items-center gap-6 bg-white/90 dark:bg-secondary/90 px-4 py-4 shadow shadow-slate-200/80 ring-1 ring-slate-900/5 backdrop-blur-sm md:px-6 rounded-2xl">
